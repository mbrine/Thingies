...
registerAudio("SoundBits1",         sourceFilePath("Bits", "Bits1.mp3"), "mp3");
registerAudio("SoundBits100",       sourceFilePath("Bits", "Bits100.mp3"), "mp3");
registerAudio("SoundBits1000",      sourceFilePath("Bits", "Bits1000.mp3"), "mp3");
registerAudio("SoundBits5000",      sourceFilePath("Bits", "Bits5000.mp3"), "mp3");
registerAudio("SoundBits10000",     sourceFilePath("Bits", "Bits10000.mp3"), "mp3");
registerAudio("SoundBits100000",    sourceFilePath("Bits", "Bits100000.mp3"), "mp3");

loadSprite("Bits1Animated", sourceFilePath("Bits", "bits1animated.png"), "gif", {
    totalframes: 56,
    frameheight: 50,
    framewidth: 50,
    framesperrow: 5,
});
loadSprite("Bits100Animated", sourceFilePath("Bits", "bits100animated.png"), "gif", {
    totalframes: 76,
    frameheight: 50,
    framewidth: 50,
    framesperrow: 5,
});
loadSprite("Bits1000Animated", sourceFilePath("Bits", "bits1000animated.png"), "gif", {
    totalframes: 76,
    frameheight: 50,
    framewidth: 50,
    framesperrow: 5,
});
loadSprite("Bits5000Animated", sourceFilePath("Bits", "bits5000animated.png"), "gif", {
    totalframes: 90,
    frameheight: 50,
    framewidth: 50,
    framesperrow: 5,
});
loadSprite("Bits10000Animated", sourceFilePath("Bits", "bits10000animated.png"), "gif", {
    totalframes: 90,
    frameheight: 50,
    framewidth: 50,
    framesperrow: 5,
});
loadSprite("Bits100000Animated", sourceFilePath("Bits", "bits100000animated.png"), "gif", {
    totalframes: 90,
    frameheight: 50,
    framewidth: 50,
    framesperrow: 5,
...
// Define the variant
loadedBitsVariants["Bits"] = {
    "variantname": "Bits",
    "tiers": [100000, 10000, 5000, 1000, 100, 1],
    "spawnBitObject": function (x, y, dx, dy, type, life) {
        const self = this;
        let bitObject = createBitObject(x, y, dx, dy, type, life, "Bits", "Bits" + type + ".png");
        switch (type) {
            case 100000:
                // Audio!
                playAudio("SoundBits100000",1.0,true);
            ...
            case 10000:
                // Audio!
                playAudio("SoundBits10000", 1.0, true);
            ...
            case 5000:
                // Audio!
                playAudio("SoundBits5000", 1.0, true);
            ...
            case 1000:
                // Audio!
                playAudio("SoundBits1000", 1.0, true);
            ...
            case 100:
                // Audio!
                playAudio("SoundBits100", 1.0, true);
                ...
                bitObject.onDestroy = function () {
                    ...
                    var intervalID = setInterval(function () {
                        ...
                        var p = new canvasobjects["sprite"]("Bits1Animated", bitObject.position.x, bitObject.position.y, 50, 50, dirX, dirY, 50);
                ...
                switch (tierType) {
                    case 100000:
                        for (let i = 0; i < amount; i++) {
                            ...
                            var bit = new canvasobjects["sprite"]("Bits100000Animated", canvas.width / 2, canvas.height / 2, 380, 380, 0, 0, 500);
                    ...
                    case 10000:
                        for (let i = 0; i < amount; i++) {
                            let bit = new canvasobjects["sprite"]("Bits10000Animated", (Math.random() * canvas.width - 270) / 2, (Math.random() * canvas.height - 270) / 2, 270, 270, Math.random() < 0.5 ? -10 : 10, Math.random() < 0.5 ? -10 : 10, 300);
                            bit.postUpdate = () => {
                                var completion = (bit.mlife - bit.life) / bit.mlife;
                                stage.globalAlpha = completion * 0.8 + 0.2;
                    ...
                    case 5000:
                        for (let i = 0; i < amount; i++) {
                            let bit = new canvasobjects["sprite"]("Bits5000Animated", (Math.random() * (canvas.width - 225)), (Math.random() * (canvas.height - 225)), 225, 225, 0, 0, 200);
                            var centerx = bit.x;
                            var centery = bit.y;
                    ...
                    case 1000:
                        for (let i = 0; i < amount; i++) {
                            let bit = new canvasobjects["sprite"]("Bits1000Animated", (Math.random() * (canvas.width - 150)), (Math.random() * (canvas.height - 150)), 150, 150, 0, 0, 150);
                            var centerx = bit.x;
                            var centery = bit.y;
                    ...
                    case 100:
                        ...
                        var hintervalID = setInterval(function () {
                            var bit = new canvasobjects["sprite"]("Bits100Animated", (Math.random() * (canvas.width - 75)), (Math.random() * (canvas.height - 75)), 75, 75, 0, 0, 91);
                            var centerx = bit.x;
                            var centery = bit.y;
